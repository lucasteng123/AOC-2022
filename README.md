...
> Edit: why not sort it when the data is being initialized. Then each actual calculation can be very simple, and while it is less efficient for part 1, it makes it much more readable. 
